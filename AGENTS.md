...
- La trazabilidad usa nombres públicos, no nombres de rutas internas. Diferenciar actualizaciones manuales y automáticas de Gestión mediante su origen registrado; no inferirlo para datos históricos. Comprobaciones automáticas de avisos y solicitudes de Minutas no demuestran creación de registros ni premios. Contrato y pruebas: `docs/OPERATIONAL_TRACE.md`.
