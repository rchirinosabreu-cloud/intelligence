...
- **Desglose interno (Rodny, 19 de septiembre de 2026):** un movimiento puede repartirse en partidas (`FinancialRecordAllocation`: valor, categoría, concepto) que suman exactamente su importe en centavos. El movimiento sigue siendo el único hecho de dinero: saldos, flujo de caja, cartera y libro lo leen a él; solo la distribución por categoría lee las partidas. Nunca convertir un desglose en varios movimientos ni permitir partidas que no cuadren. Categorías: `docs/FINANCIAL_CATEGORIES.md` (incluye `PRESTAMO`).
