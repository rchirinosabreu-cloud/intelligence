...
test('activity source has one card implementation and no AnimatePresence portal ownership', async () => {
  const activityMap = await readFile('src/components/modules/Activity/ActivityMap.jsx', 'utf8');
  const operationalCalendar = await readFile('src/components/modules/Activity/OperationalCalendar.jsx', 'utf8');
