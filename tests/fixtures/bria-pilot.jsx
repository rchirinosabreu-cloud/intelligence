...
function Pilot() {
  ...
  return <main className="min-h-screen bg-zinc-50 px-4 py-8 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100 sm:p-10"><div className="mx-auto max-w-4xl space-y-6">
    ...
    <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">Prueba la propuesta, aprobación y revocación de reglas para un cliente. Las decisiones se guardan en PostgreSQL local. «Buscar aprendizajes» utiliza una respuesta de IA simulada con fuentes ficticias. El desglose del puntaje también es una muestra del cálculo candidato, no una valoración real.</p>
