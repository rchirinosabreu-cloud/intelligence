...
export function dashboardDemoKanbanTasks(now = new Date()) {
  ...
  return [
    ...
    // In progress for the demo person: with the commitment active it stays workable (Rodny, 21 September 2026).
