...
test('Vision Extraction Service - OpenAI Mock and Math Validation', async (t) => {
            ...
            choices: [
                {
                    message: {
                        content: JSON.stringify({
                            ...
                            platform: "META_ADS",
                            dataset: [
                                { label: "Día 1", value: 100, percentage: null, results: null, impressions: null, reach: null },
                                { label: "Día 2", value: 150, percentage: null, results: null, impressions: null, reach: null }
                            ]
                        })
                    }
                }
    ...
    await t.test('Editorial narrative prompt and format generation logic', async () => {
                            ...
                            sections: [
                                {
                                    ...
                                    sectionCategory: "ADS",
                                    platform: "META_ADS",
                                    dataset: [{ label: "Día 1", value: 100, percentage: null, results: null, impressions: null, reach: null }],
        ...
        try {
            ...
            const sections = [{ sectionId: "sec-1", chartType: "LINE_CHART", title: "Rendimiento y Tendencia", sectionCategory: "ADS", platform: "META_ADS", dataset: [{ label: "Día 1", value: 100, percentage: null, results: null, impressions: null, reach: null }] }];
