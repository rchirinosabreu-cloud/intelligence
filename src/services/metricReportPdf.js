...
.editorial-comment { background:var(--soft); border-radius:10px; padding:16px 18px; margin:16px 0 24px; break-inside:avoid; } h4 { font-size:13px; margin:0 0 8px; } .editorial-comment p { margin:7px 0; } .editorial-chart { margin:20px 0; padding:18px; border:1px solid var(--line); border-radius:12px; } .editorial-chart figcaption { font-weight:600; margin-bottom:16px; } .chart-row { display:grid; grid-template-columns:120px minmax(0,1fr) 84px; align-items:center; gap:12px; margin:12px 0; break-inside:avoid; } .chart-label { font-size:11px; } .chart-row>strong { font-size:11px; text-align:right; font-variant-numeric:tabular-nums; } .chart-track { height:14px; border-radius:0 6px 6px 0; background:var(--soft); } .chart-track>span { display:block; height:100%; border-radius:0 6px 6px 0; background:var(--accent); } .editorial-recommendation { border-top:1px solid var(--line); padding:18px 0; break-inside:avoid; } .priority { display:inline-block; color:var(--accent); font-size:10px; font-weight:600; margin-bottom:7px; } .editorial-closing { padding:20px; border-radius:12px; background:var(--soft); margin:24px 0; break-inside:avoid; }
...
@media (prefers-color-scheme: dark) { :root { --paper:#111827; --ink:#edf2f7; --muted:#bac5d3; --line:#354153; --soft:#1c2635; --accent:#c4b5fd; } .agency-signoff img { filter:none; } }
