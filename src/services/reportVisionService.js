...
// Compatibility binding for deployments that still contain calls emitted under
// the original helper name. Keep local so mixed build artifacts cannot throw.
export const filterTopContentRows = filterExtractedTopContentRows;
