  ...
  return (
    <div
      className={cn(
        ...
        // Light Mode Styles
        "bg-white border border-zinc-200/60 shadow-sm hover:shadow-md hover:border-zinc-300/60",

        // Dark Mode Styles (Glassmorphism)
        "dark:bg-zinc-900/40 dark:backdrop-blur-xl dark:border-white/5",
        "dark:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.5)] dark:ring-1 dark:ring-white/5",

        // Dark Mode Interactive States
        "dark:hover:bg-zinc-900/60 dark:hover:border-indigo-500/20 dark:hover:ring-indigo-500/20 dark:hover:shadow-[0_20px_48px_-12px_rgba(99,102,241,0.15)]",
