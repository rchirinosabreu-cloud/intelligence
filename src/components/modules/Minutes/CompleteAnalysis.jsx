...
import { Brain, Loader2, AlertTriangle, CheckCircle, ExternalLink, Download } from '@/components/ui/icons';
         ...
         <div className="bg-white dark:bg-zinc-900 rounded-xl p-6 border border-border shadow-md space-y-4">
          <div className="flex flex-col items-center gap-4 text-center pb-4 border-b border-border">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
              ...
              <Button onClick={handleDownloadPDF} disabled={htmlLoading || loading || !analysisData} className="flex-1 bg-primary hover:bg-primary/90 text-primary-foreground border border-primary">
