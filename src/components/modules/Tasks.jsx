  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-white mb-1">Pendientes</h2>
          <p className="text-zinc-400 text-sm">Gestión de tareas y entregables por cliente.</p>
        </div>
      ...
      >
        <AnimatePresence mode='popLayout'>
          {filteredTasks.map((task) => (
            ...
            >
              <Card className="h-full group hover:border-indigo-500/30 transition-all cursor-pointer relative overflow-hidden">
                ...
                <div className="flex flex-col h-full gap-4">
                  ...
                  <h3 className="text-lg font-semibold text-white leading-tight group-hover:text-indigo-400 transition-colors">
                    {task.task}
                  </h3>
                  ...
                  <div className="mt-auto pt-4 border-t border-zinc-800/50 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                       ...
                       />
                       <span className="text-xs text-zinc-500 font-medium">Responsable</span>
                    </div>
