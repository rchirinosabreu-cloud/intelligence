...
- Proponer se ubica debajo de la explicación. Aprobar es texto turquesa y rechazar es neutro, sin superficie. «Ver detalle» reúne fuentes e historial, con el historial plegado inicialmente. Ajustar/revocar/eliminar se ubican en «⋯» según estado y permisos; solo revocar/eliminar usan el token destructivo. Todos conservan foco visible y objetivos táctiles de 44 px. El modo oscuro deriva un rojo accesible del mismo token.
