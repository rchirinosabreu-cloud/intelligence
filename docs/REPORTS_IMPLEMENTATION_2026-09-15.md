...
3. **Modelo de visión.** La primera versión heredaba la configuración central. La corrección `report-evidence-2026-09-16.1` usa exclusivamente `OPENAI_MODEL_REPORT_VISION`, con `gpt-6-astra` como valor predeterminado evaluado. El modelo de los demás módulos permanece independiente. Ver `REPORTS_PRODUCTION_REGRESSION_2026-09-16.md`.
